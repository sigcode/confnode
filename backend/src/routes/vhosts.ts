...
// Uses hostname:443 style (Apache resolves to IP, joins existing SSL group).
// Detects whether proxy or DocumentRoot and mirrors relevant directives.
